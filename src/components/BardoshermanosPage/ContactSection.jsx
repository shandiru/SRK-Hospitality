          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  <span className="font-semibold text-orange-600">Latin Tapas</span><br />
                  Monday to Thursday: 5:00 PM – 9:00 PM<br />
                  Friday and Saturday: 5:00 PM – 6:30 PM<br />
                  Sunday: 5:00 PM – 9:00 PM
                </p>

                <p className="text-gray-600 mt-3">
                  <span className="font-semibold text-orange-600">Breakfast & Brunch</span><br />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  52 Queens Road, Clarendon Park,<br />
                  Leicester, LE2 1TU.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">0116 270 8404</p>
