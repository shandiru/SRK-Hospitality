      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            {/* Address */}
            <a
              href="https://maps.app.goo.gl/B5VWg6z4geNSdNnY6"
              target="_blank"
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:info@walnut-tree.co.uk"
                  className="font-medium hover:text-[#E1B43B]"
                >
                  info@walnut-tree.co.uk
                </a>
              </div>
            </div>
            ...
            {/* Website */}
            <a
              href="https://alnaseebrestaurant.co.uk/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-start gap-4 group"
            >
            ...
            <div className="flex gap-4 pt-4">
              <a
                href="https://www.instagram.com/alnaseebresataurant/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://web.facebook.com/AlNaseeb.LongEation/?_rdc=1&_rdr#"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full transition hover:scale-105"
                style={{
          ...
          <form className="space-y-6">
            ...
            <div>
              <button
                ...
                style={{ backgroundColor: BRAND_GOLD, color: isDark ? '#000' : '#fff' }}
              >
                SUBMIT
              </button>
            </div>
