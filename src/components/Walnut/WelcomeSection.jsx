  ...
  return (
    <section className="relative w-full h-[100vh] font-[Playfair_Display]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        ...
        >
          A boutique stay that blends modern comfort with classic warmth. Discover The Walnut Tree, a charming 3-star hotel where relaxed hospitality and thoughtful details create the perfect place to unwind.
        </p>
